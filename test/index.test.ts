...
describe('simplepolygon', () => {
  test('processes simple polygon correclty', async () => {
    const results = colorize(simplepolygon(simple as Feature<Polygon>))
  ...
  test('processes complex polygon correclty: complex feature must have more than 2 features', async () => {
    const results = colorize(simplepolygon(complex as Feature<Polygon>))
  ...
  test('processes polygon with hole correclty', async () => {
    const results = colorize(simplepolygon(withHole as Feature<Polygon>))
...
function colorize(
  ...
  featureEach(features, (feature: Feature<Polygon>, index: number) => {
